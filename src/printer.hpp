...
public:
  ...
  friend auto operator<<(std::ostream& os, const HeaderColor& h) -> std::ostream& {
...
inline auto header(Color c) -> HeaderColor {
  return HeaderColor(c);
}
...
public:
  ...
  friend auto operator<<(std::ostream& os, const MajorColor& m) -> std::ostream& {
...
inline auto major(Color c) -> MajorColor {
  return MajorColor(c);
}
...
public:
  ...
  friend auto operator<<(std::ostream& os, const HeaderAlignment& h) -> std::ostream& {
...
inline auto header_align(Alignment a) {
  return HeaderAlignment(a);
}
...
public:
  ...
  friend auto operator<<(std::ostream& os, const MajorAlignment& m) -> std::ostream& {
...
inline auto major_align(Alignment a) {
  return MajorAlignment(a);
}
...
public:
  ...
  friend auto operator<<(std::ostream& os, const DataAlignment& d) -> std::ostream& {
...
inline auto align(Alignment a) {
  return DataAlignment(a);
}
...
inline auto BeginStyle(std::ostream& os, const TextStyle& style, bool enabled) -> std::ostream& {
  if (!enabled) {
    return os;
  }
...
inline auto RenderDebug(std::ostream& os, const Table& table) -> std::ostream& {
  os << table.title << " {\n";
...
inline auto ApplyStyle(std::ostream& os, const TextStyle& style, bool enabled) -> void {
  if (!enabled) {
    return;
  }
...
inline void DrawBorder(std::ostream& os, std::string_view left, std::string_view middle,
...
inline auto RenderPretty(std::ostream& os, const Table& table) -> std::ostream& {
  ...
  DrawBorder(os, border.top_left, border.top_mid, border.top_right, border.horizontal, widths);
  ...
  DrawBorder(os, border.mid_left, border.mid_mid, border.mid_right, border.horizontal, widths);
  ...
  DrawBorder(os, border.bottom_left, border.bottom_mid, border.bottom_right, border.horizontal,
             widths);
